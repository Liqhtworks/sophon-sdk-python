...
* `SOPHON_MINUS_ESPRESSO_MINUS_HQ` (value: `'sophon-espresso-hq'`)

* `SOPHON_MINUS_CORTADO_MINUS_HQ` (value: `'sophon-cortado-hq'`)

* `SOPHON_MINUS_AMERICANO_MINUS_HQ` (value: `'sophon-americano-hq'`)
...
* `SOPHON_MINUS_ESPRESSO_MINUS_HQ_MINUS_10BIT` (value: `'sophon-espresso-hq-10bit'`)

* `SOPHON_MINUS_CORTADO_MINUS_HQ_MINUS_10BIT` (value: `'sophon-cortado-hq-10bit'`)

* `SOPHON_MINUS_AMERICANO_MINUS_HQ_MINUS_10BIT` (value: `'sophon-americano-hq-10bit'`)
