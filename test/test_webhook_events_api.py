...
from sophon_sdk.api.webhook_events_api import WebhookEventsApi
...
class TestWebhookEventsApi(unittest.TestCase):
    ...
    def test_receive_job_terminal_webhook(self) -> None:
        """Test case for receive_job_terminal_webhook
