    ...
    def make_instance(self, include_optional) -> ListJobsResponse:
        ...
        if include_optional:
            return ListJobsResponse(
                jobs = [
                    sophon_sdk.models.job_response.JobResponse(
                        id = 'job_abc123def456', 
                        status = 'queued', 
                        status_reason = '', 
                        attempt = 56, 
                        ...
                        source = sophon_sdk.models.job_source_info.JobSourceInfo(
                            name = '', 
                            bytes = 56, 
                            sha256 = '', 
                            ...
                            frame_rate = '23.976', ), 
                        progress = sophon_sdk.models.job_progress.JobProgress(
                            stage = '', 
                            phase = null, 
                            percent = 0, 
                            phase_percent = 0, 
                            ...
                            frames_done = 56, 
                            frames_total = 56, ), 
                        output = sophon_sdk.models.job_output_info.JobOutputInfo(
                            state = 'pending', 
                            container = '', 
                            audio = True, 
                            target_height = 1080, 
