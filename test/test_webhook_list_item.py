...
class TestWebhookListItem(unittest.TestCase):
    """WebhookListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookListItem:
