...
from sophon_sdk.configuration import Configuration
from sophon_sdk.api_response import ApiResponse, T as ApiResponseT
import sophon_sdk.models
from sophon_sdk import rest
from sophon_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sophon_sdk.models, klass)
