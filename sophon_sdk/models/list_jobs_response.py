...
class ListJobsResponse(BaseModel):
    ...
    next_cursor: Optional[StrictStr] = Field(default=None, description="Opaque cursor for the next page. Null when no more results.")
    has_more: StrictBool
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["jobs", "next_cursor", "has_more"]
