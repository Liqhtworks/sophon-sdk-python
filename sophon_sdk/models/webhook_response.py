...
class WebhookResponse(BaseModel):
    ...
    id: StrictStr
    url: StrictStr
    secret: StrictStr = Field(description="HMAC signing secret (64-char hex string, 32 random bytes). Only returned on creation. Use to verify webhook delivery signatures. ")
    active: StrictBool
    created_at: datetime
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "url", "secret", "active", "created_at"]
