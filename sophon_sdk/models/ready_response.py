...
class ReadyResponse(BaseModel):
    ...
    """ # noqa: E501
    ready: StrictBool
    checks_failed: Optional[List[StrictStr]] = Field(default=None, description="Names of failed readiness checks (database, disk_critical, draining, workers_dead).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ready", "checks_failed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ready": obj.get("ready"),
            "checks_failed": obj.get("checks_failed")
        })
