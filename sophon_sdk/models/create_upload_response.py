...
class CreateUploadResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    chunk_size: StrictInt = Field(description="Size of each chunk in bytes. Tiered by file size: <64 MB = whole file, <=1 GB = 8 MB, <=10 GB = 16 MB, >10 GB = 32 MB. ")
    total_chunks: StrictInt
    expires_at: datetime = Field(description="Upload session expiry (24 hours from creation).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "chunk_size", "total_chunks", "expires_at"]
